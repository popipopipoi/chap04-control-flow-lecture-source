...
public class A_for {
    ...
    public void testForExample4() {
        ...
        * first와 second 중 어느 것이 더 큰 수인지를 확인하면 작은수 ~ 큰수까지의 합계를 구하는 로직을 작성 할 수 있다.
        * */
        int min = 0;
        int max = 0;
    ...
    public void printSimpleGugudan() {
        ...
        /* 키보드로 2~9사이의 수를 입력 받아 구구단을 출력하고,
        * 해당 범위의 수를 입력하지 않으면 "반드시 2~9 사이의 양수를 입력해야합니다"를 출력한다.
        * */
